...
I am a postdoctoral researcher at [Aalto University](https://aalto.fi), working in the [Computational Behavior Lab](https://cbl.aalto.fi/) with [Prof. Dr. Antti Oulasvirta](https://users.aalto.fi/~oulasvir/). I earned my Ph.D. in Computer Science from [ETH Zürich](https://ethz.ch), advised by [Prof. Dr. Otmar Hilliges](https://ait.ethz.ch/people/hilliges) and [Prof. Dr. Christian Holz](https://christianholz.net) in the [AIT Lab](https://ait.ethz.ch). My work integrated models of human behavior into intelligent control strategies for user interfaces, haptics, and adaptive systems.

Before my Ph.D., I completed a joint M.Sc. in Computer Science, specializing in intelligent systems, from [Aalto University](https://aalto.fi) and the [University of Twente](https://www.utwente.nl/en/). I hold a B.Sc. in Industrial Design from [Eindhoven University of Technology](https://tue.nl), providing a foundation in design thinking and computational methods.